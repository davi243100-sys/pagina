...
<div class="product">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        ...
        <span class="small" style="color:green; font-weight:bold;">R$ 0</span>
    </div>
    <div class="small">Conta inicial com Buddha (entrega imediata).</div>
    <button onclick="abrirEntrega('ClarenceMcintyre4402','valeria2')">PEGAR GRÁTIS</button>
</div>

<!-- Conta Buddha + CDK + 2800 -->
<div class="product">
    <div style="display:flex; justify-content:space-between; align-items:center;">
        <strong>Buddha + CDK + Level 2800</strong>
        <span class="small">R$ 40</span>
    </div>
    <div class="small">Conta completa, forte e pronta para tudo.</div>
...
<div class="product">
    ...
    <div class="small">Serviço completo com bônus e prioridade.</div>
